...
class TemplateRegistry:
    ...
    def _load_curated_templates(self):
        ...
        # 1. Web Apps
        self.register_template(TemplateManifest(
            id="portfolio-web",
            ...
            framework="vanilla",
            variables=[
                TemplateVariable(name="project_name", description="Name of portfolio project", default="My Portfolio"),
                TemplateVariable(name="author", description="Author name", default="Developer"),
                TemplateVariable(name="description", description="Bio summary", default="Software Engineer building awesome things"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            framework="react",
            variables=[
                TemplateVariable(name="project_name", description="Blog title", default="Tech Chronicles"),
                TemplateVariable(name="description", description="Blog topic", default="Insights on modern software engineering"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            framework="nextjs",
            variables=[
                TemplateVariable(name="project_name", description="Store name", default="Apex Goods"),
                TemplateVariable(name="description", description="Store catalog description", default="Curated premium apparel and gear"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            framework="react",
            variables=[
                TemplateVariable(name="project_name", description="SaaS Product Name", default="CloudFlow"),
                TemplateVariable(name="description", description="Value proposition", default="Automate cloud deployments with intelligent pipelines"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            framework="react",
            variables=[
                TemplateVariable(name="project_name", description="Dashboard title", default="Operations Control"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            framework="fastapi",
            variables=[
                TemplateVariable(name="project_name", description="Service name", default="Item Service"),
                TemplateVariable(name="description", description="API purpose", default="FastAPI microservice for CRUD operations"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            framework="fastapi",
            variables=[
                TemplateVariable(name="project_name", description="Auth realm name", default="Auth Hub"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            framework="fastapi",
            variables=[
                TemplateVariable(name="project_name", description="Webhook service", default="Event Ingestor"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            language="python",
            framework="graphql",
            files={"app/schema.py": "import strawberry\n@strawberry.type\nclass Query:\n    hello: str = 'world'\n"},
        ))
        ...
        self.register_template(TemplateManifest(
            ...
            language="python",
            framework="fastapi",
            files={"app/ws.py": "from fastapi import FastAPI, WebSocket\napp = FastAPI()\n@app.websocket('/ws')\nasync def ws_endpoint(ws: WebSocket): await ws.accept()\n"},
        ))
        ...
        self.register_template(TemplateManifest(
            ...
            framework="cli",
            variables=[
                TemplateVariable(name="project_name", description="CLI tool command name", default="forge-cli"),
            ],
            files={
        ...
        self.register_template(TemplateManifest(
            ...
            language="python",
            framework="script",
            files={"scraper/main.py": "import httpx\nfrom bs4 import BeautifulSoup\nasync def fetch(url): pass\n"},
        ))
        ...
        self.register_template(TemplateManifest(
            ...
            language="typescript",
            framework="npm",
            files={"package.json": '{"name": "ts-lib", "main": "dist/index.js"}', "src/index.ts": "export const add = (a: number, b: number) => a + b;\n"},
        ))
    ...
    def list_templates(
        ...
        if query:
            q = query.lower()
            results = [t for t in results if q in t.name.lower() or q in t.description.lower() or q in t.id.lower()]
