...
class TaskEntity(BaseModel):
    ...
    error_message: str | None = Field(default=None, description="Error reason if state is FAILED or BLOCKED")
...
class TaskNode(BaseModel):
    ...
    result: dict[str, Any] | None = Field(default=None, description="Output artifacts or return data")
...
class TaskEdge(BaseModel):
    ...
    condition: str | None = Field(default=None, description="Optional conditional transition expression")
...
class Checkpoint(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=lambda: datetime.now(UTC))
    description: str | None = Field(default=None, description="Human-readable milestone description")
