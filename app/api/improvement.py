...
@improvement_router.get("/report", response_model=SelfImprovementReport, summary="Get Self-Improvement Analysis Report")
...
@improvement_router.post("/apply/{proposal_id}", response_model=ImprovementProposal, summary="Apply Approved Proposal")
