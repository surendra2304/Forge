...
async def handle_build(
    ...
    with Progress(
        ...
        is_static_web = any(k in goal_lower for k in ["website", "landing page", "web page", "html", "portfolio", "css", "calculator website", "static"]) and not any(k in goal_lower for k in ["backend", "fastapi", "flask", "api", "database", "sqlite"])
