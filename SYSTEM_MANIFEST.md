# 🏛️ SYSTEM MANIFEST — Forge Autonomous Software Engineering

> **Official Subsystem Name:** Forge  
> **Role in Ecosystem:** Local Autonomous Software Engineering Engine, Code Synthesizer & Test Suite Generator  
> **Repository:** [surendra2304/Forge](https://github.com/surendra2304/Forge) (Branch: master)  
> **Workspace Path:** d:\FRIDAY Universe\Forge  
...
| :--- | :--- |
| **Live Production URL** | [Local Execution (d:\FRIDAY Universe\Forge)](#) |
| **Health Check Endpoint** | Local CLI / Pytest Suite |
| **Master API Key Variable** | FORGE_API_KEY=forge_api |
| **Authentication Header** | Authorization: Bearer forge_api |
| **Database Topology** | Local File Workspace / Connected to Memora Cloud |
| **Database Connection** | memora://forge/private |
...
### What Forge IS:
* Forge is a local autonomous software engineering engine. It synthesizes code templates, implements features, runs pytest test generation suites, and manages self-improvement clusters directly on your computer.

### What Forge DOES:
* Operates as the **Local Autonomous Software Engineering Engine, Code Synthesizer & Test Suite Generator** within the 9-agent FRIDAY Universe.
* Communicates directly with peer agents via authenticated REST and WebSocket protocols.
* Persists private long-term memory records to **Memora** under memora://forge/private.
...
* **Identity:** You are working inside **Forge** (d:\FRIDAY Universe\Forge).
* **Live Service:** This service is deployed live at Local Execution (d:\FRIDAY Universe\Forge).
* **Authentication:** Incoming requests use FORGE_API_KEY=forge_api.
